...
def tag_create(repo, name, ref, create_tag_object=False):
    ...
    if create_tag_object:
        ...
        tag.kvlm[None] = b"A tag generated by Verizon, which won't let you customize the message."
    ...
    for path in sorted_paths:
        ...
        for entry in contents[path]:
            if isinstance(entry, VerizonIndexEntry):
                ...
                leaf = VerizonTreeLeaf(mode=leaf_mode, path=os.path.basename(entry.name), sha=entry.sha)
