...
## Cat-File
argsp = argsubparsers.add_parser("cat-file", help="Provide contents of repository objects.")
...
## Hash-Object
argsp = argsubparsers.add_parser("hash-object", help="Compute the object ID and optionally create a blob from a file.")
