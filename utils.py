from imports import *
from classes import VerizonRepository, VerizonTag, VerizonIgnore, VerizonTree, VerizonIndexEntry, VerizonTreeLeaf, VerizonCommit
...
def repo_create(path):
    ...
    with open(repo_file(repo, "description"), "w") as f:
        f.write("This is an unnamed repo, edit this file 'description' to name the repo. ")
